...
related_targets: ["docs/styles.css","docs/demo.js"]
---

# Credit Monitor landing page

## Scope and mode

- Target: `docs/index.html` with `docs/styles.css` and `docs/demo.js` as supporting files.
- Visitor mode: Persuade.
- Scope: redesign the public landing page presentation while preserving extension runtime behavior, release artifacts, permissions, product facts, and download targets.
...
None material to implementation.
